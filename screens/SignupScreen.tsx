...
function OtpModal({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setSeconds((prev) =>
        prev <= 1 ? (clearInterval(interval), 0) : prev - 1,
      );
    }, 1000);
  ...
  return (
    ...
    >
      ...
      <View className="absolute bottom-0 left-0 right-0 px-8 bg-white rounded-t-3xl pt-7 pb-14">
        ...
        {/* 타이틀 & 타이머 */}
        <Text className="mb-1 text-lg font-bold text-center text-black">
          인증번호 입력
        </Text>
