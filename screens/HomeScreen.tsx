    ...
    <SafeAreaView className="flex-1 bg-gray-50" edges={['top']}>
      ...
      >
          ...
          >
            ...
            <View className="px-5 pb-5 pt-5" style={{ minHeight: 132 }}>
              ...
              <View className="mt-4 flex-row gap-10">
                ...
                <Pressable onPress={() => navigation.navigate('MyRoute')} className="flex-row items-center">
                  <View className="h-9 w-9 items-center justify-center rounded-xl bg-white">
        ...
        <View style={{ marginTop: 22 }}>
          <SectionHeader title="최근 채팅" actionLabel="더보기" onPressAction={() => navigation.navigate('Chat')} />
        ...
        <View style={{ marginTop: 22 }}>
          <SectionHeader
            title="주변 인기 코스"
            actionLabel="자세히 보기"
            onPressAction={() => navigation.navigate('SharedRoute', { openFilter: true, openAsPopular: true })}
          />
          <ScrollView
            horizontal
                  ...
                  <View className="px-4 pb-4 pt-3">
                    ...
                    <View className="mt-2 flex-row items-center">
                      <View className="rounded bg-green-100 px-2 py-0.5">
                        <Text className="text-[11px] font-semibold text-green-700">{course.departure}</Text>
                      </View>
                      <Ionicons name="arrow-forward" size={14} color="#9ca3af" style={{ marginHorizontal: 6 }} />
                      <View className="rounded bg-red-100 px-2 py-0.5">
                        <Text className="text-[11px] font-semibold text-red-700">{course.arrival}</Text>
                      </View>
                    </View>
                  </View>
                </View>
